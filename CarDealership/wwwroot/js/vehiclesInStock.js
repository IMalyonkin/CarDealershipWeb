//файл для работы со страницей автомобилей в наличии
...
var Models = (function () {
    ...
    var render = function (data) {
        ...
        //привязка инициализации автомобилей к изменению модели
...
var Vehicles = (function () {
    ...
    var init = function () {
        ...
        var id = $('#selModel').val(); 
        if (id == 0 || id == undefined) //если модель не выбиралась или выбраны все модели
            getData(url);//получение всех автомобилей
        else
            getData(url + "model/" + id); //получение одного автомобиля
    };

    //получене данных об автомобилях
    var getData = function (url) {
        $.ajax({
            url: url,
            type: 'GET',
    ...
    var render = function (data) {
        ...
        if (vehicles.length > 0) {
            for (var i in vehicles) {
                var src = (vehicles[i].model == "Q7") ? "/images/q7.jpg" : "/images/a5.jpg";
                ...
                html += '<img class="logo" width=320 height=200 src="' + src + '">'
...
//модуль окна просмотра автомобиля
var ViewModal = (function () {

    var vehId = ""; //id автомобиля
    let vehicle = ""; //id модели
